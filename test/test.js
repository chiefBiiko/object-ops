...
describe('object-ops', () => {
  ...
  describe('.every(obj, func, that)', () => {
    it('should assert all func returns are true', () => {
  ...
  describe('.some(obj, func, that)', () => {
    it('should assert some func returns are true and shortcut', () => {
  ...
  describe('.randomProp(obj)', () => {
    it('should return an [ key, val ] at random', () => {
  ...
  describe('.keysOf', () => {
    it('should return an array of matching keys', () => {
